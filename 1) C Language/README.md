...
# Career Starting
From 2nd semester i started my coading career, i wrote my first program, hello world in C and C is my first programming language from which i started my coading currier, Gaurav Sharma Sir gave us this programs for practice i had build many more program other then this but i wont managing git from that time so eventually i lost them 😔.
